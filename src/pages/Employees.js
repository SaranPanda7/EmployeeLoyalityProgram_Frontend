...
import { Nav, Tab, Dropdown, Tabs, Modal } from "react-bootstrap";
    ...
    <>
      <div className="page-wrapper">
        <div className="content container-fluid">
          <Tabs defaultActiveKey="employeesSync" className="nav-tabs-bottom">
            <Tab eventKey="employeesSync" title="Employees Sync">
              <Tab.Container
              ...
              >
                <div className="page-header">
                  <div className="row align-items-center">
                    <div className="col">
                      <h3 className="page-title">Employees Sync</h3>
                      <ul className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active">
                          <i className="la la-users-cog"></i> Employees Sync
                        </li>
                      </ul>
                    </div>
                    <div className="col-auto float-right ml-auto">
                      ...
                      {/* <button className="btn add-btn" type="button">Sync Employees</button> */}
            ...
            <Tab eventKey="employeesProfiles" title="Employees Profiles">
              <Tab.Container
                id="left-tabs-example"
                defaultActiveKey="gridViewProfiles"
              >
                <div className="page-header">
                  <div className="row align-items-center">
                    <div className="col">
                      <h3 className="page-title">Employee Profiles</h3>
                      <ul className="breadcrumb">
                        <li className="breadcrumb-item">
                        ...
                        <li className="breadcrumb-item active">
                          <i className="la la-user-check"></i> Employees
                          Profiles
                        </li>
                      </ul>
                    </div>
                ...
                <Tab.Content>
                  <Tab.Pane eventKey="gridViewProfiles">
                    <div className="row staff-grid-row">
                  ...
                  <Tab.Pane eventKey="listViewProfiles">
